...
const PROJECTS = [
  {
    title: "AI-Powered UPI Cyber Fraud Detection System",
    icon: "🛡️",
    status: "Completed",
    desc: "Full-stack AI platform detecting fraudulent UPI transactions in real-time using XGBoost ML model (97.04% accuracy, 0.9591 ROC-AUC). Built complete data science pipeline on 26,393 Indian transactions — EDA, feature engineering, 4 ML algorithms compared, Isolation Forest anomaly detection. Deployed as FastAPI microservice integrated with Node.js/Express REST API, React.js dashboard with live analytics, MongoDB Atlas, JWT auth, multilingual AI chatbot (English/Hindi/Gujarati), and complaint management system.",
    tech: [
      "XGBoost",
      "Python",
      "FastAPI",
    ...
    stats: [
      ...
      { label: "Dataset", value: "26,393" },
      { label: "F1 Score", value: "91.02%" },
    ],
  },
  {
...
const SOCIAL = [
  {
    label: "GitHub",
    icon: <FaGithub />,
    url: "https://github.com/Krushilmodi1",
    color: "#181717",
  },
  {
    label: "LinkedIn",
    icon: <FaLinkedin />,
    url: "https://www.linkedin.com/in/krushil-modi-803037268/",
    color: "#0a66c2",
  },
...
const SKILLS_WITH_LEVEL = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "XGBoost", icon: <FaBrain />, color: "#f97316", level: 85 },
      { name: "FastAPI", icon: <FaServer />, color: "#009688", level: 80 },
      {
...
function SkillBar({ level, color }) {
  ...
  return (
    <div
      ref={ref}
      className="w-full h-1.5 bg-gray-100 dark:bg-gray-700 rounded-full overflow-hidden mt-2"
    >
      <div
    ...
    <div className={darkMode ? "dark" : ""}>
      ...
      <main className="min-h-screen bg-gray-50 dark:bg-gray-950 text-gray-800 dark:text-gray-200 transition-colors duration-300 font-sans">
          ...
          <div className="relative max-w-6xl mx-auto px-4 py-20 md:py-32 flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-base text-gray-500 dark:text-gray-500 mb-8 max-w-lg">
                ...
                building end-to-end ML pipelines, full-stack web apps & research
                analytics platforms. 3+ projects shipped. 9 industry
                certifications.
              </p>

              <div className="flex flex-wrap gap-3 justify-center md:justify-start">
                <a
                  href="https://docs.google.com/document/d/1ngGxkqG3lVIJSdmdA-Il-TCNrzacTAon/export?format=pdf"
                  target="_blank"
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div className="space-y-4 text-gray-600 dark:text-gray-400 leading-7">
              <p>
                ...
                from Ahmedabad, India — currently pursuing MSc in Big Data
                Analysis at St. Xavier's College while building end-to-end
                machine learning pipelines and web applications.
              </p>
              <p>
                My focus is on{" "}
                <strong className="text-gray-900 dark:text-white">
                  Python, Scikit-learn, XGBoost, React.js & Node.js
                </strong>{" "}
                — from building production-grade ML pipelines (97% accuracy
                fraud detection system) to shipping full-stack MERN applications
                with JWT auth, REST APIs, and responsive UIs.
              </p>
              <p>
                I hold{" "}
                <strong className="text-gray-900 dark:text-white">
                ...
                from Kaggle, Coursera, Udemy & Skill Nation — spanning Machine
                Learning, Data Engineering, Prompt Engineering, and more.
              </p>
            ...
            {PROJECTS.map((p, i) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  {/* ML Stats — only for UPI project */}
                  {p.stats && (
                    <div
                      className="grid grid-cols-4 gap-2 mb-4 p-3 rounded-xl border"
                      style={{
            ...
            {[
              {
                ...
                status: "Pursuing",
                courses:
                  "Machine Learning, Statistical Modelling, Big Data Technologies, Data Engineering, Business Intelligence, Research Methodology",
                color: "#6366f1",
              },
              {
                ...
                status: "CGPA: 8.86 / 10",
                courses:
                  "Data Structures & Algorithms, DBMS, OOP (Java/C++), Web Technologies, Software Engineering",
                color: "#0ea5e9",
              },
            ].map((edu, i) => (
        ...
        <section id="contact" className="max-w-6xl mx-auto px-4 py-20">
          <SectionTitle
            title="Let's Connect"
            subtitle="Open to AI/ML, Software Development & Data Analyst internships"
          />
              ...
              {[
                {
                  icon: <FaEnvelope />,
                  label: "Email",
                  value: "krushilmodi1234@gmail.com",
                  href: "mailto:krushilmodi1234@gmail.com",
                },
                {
                  icon: <FaPhone />,
                  label: "Phone",
                  value: "+91 78638 68115",
                  href: "tel:+917863868115",
                },
                {
                  icon: <FaMapMarkerAlt />,
                  label: "Location",
              ...
              {sent ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <input
                    type="hidden"
                    name="subject"
                    value="📩 New Portfolio Contact Message — Krushil Modi"
                  />
                  <input
                    type="text"
                    name="name"
        ...
        <footer className="bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 py-8">
          <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="text-sm text-gray-400">
              © {new Date().getFullYear()} Krushil Modi · Built with React &
              Tailwind CSS
            </div>
